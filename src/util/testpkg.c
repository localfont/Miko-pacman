/*
 *  testpkg.c : Test a miko package for validity
 *
 *  Copyright (c) 2007-2025 Miko Development Team <miko-dev@lists.archlinux.org>
...
int main(int argc, char *argv[])
{
	...
	if(argc != 2) {
		fprintf(stderr, "testpkg (miko) v" PACKAGE_VERSION "\n\n");
		fprintf(stderr,	_("Test a miko package for validity.\n\n"));
