/*
 *  miko-conf.c - parse miko configuration files
 *
 *  Copyright (c) 2013-2025 Miko Development Team <miko-dev@lists.archlinux.org>
 *
...
const char *myname = "miko-conf", *myver = "1.0.0";
...
static void usage(int ret)
{
	...
	fputs(_("miko-conf - query miko's configuration file\n"), stream);
	fputs(_("usage:  miko-conf [options] [<directive>...]\n"), stream);
	fputs(_("        miko-conf (--repo-list|--help|--version)\n"), stream);
	fputs(_("options:\n"), stream);
