...
# TODO: hack to prevent miko trying to validate the downloaded packages
p404 = pmpkg('pkg404')
...
#self.addrule("MIKO_RETCODE=0") # TODO
self.addrule("MIKO_OUTPUT={}".format(normal_url.replace("http://", "")))
self.addrule("!MIKO_OUTPUT={}".format(cache_url.replace("http://", "")))
